                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <span>Services Page (Section 1)</span>
                        </div>
                        <div>
                    ...
                    <div class="card-body">
                        <div id="services_table1" class="table-responsive"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div>
                            <i class="fa fa-table"></i>
                            <span>Services Page (Section 2)</span>
                        </div>
                    </div>
                    <div class="card-body">
                        <div id="services_table2" class="table-responsive"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form method="post" id="form2" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input required id="bonus" name="bonus" type="text" class="form-control" placeholder="Enter Your Regular Price">
                        </div>
                        <div class="form-group">
                            <label>Offer Text</label>
                            <input required id="offer" name="offer" type="text" class="form-control" placeholder="Enter Your Offer Price">
                        </div>
                        <div class="form-group">
                            <label>Text One</label>
                            <input required id="text1" name="text1" type="text" class="form-control" placeholder="Enter Your Offer Text">
                        </div>
                        <div class="form-group">
                            <label>Text Two</label>
                            <input required id="text2" name="text2" type="text" class="form-control" placeholder="Enter Your Button Text">
                        </div>
                        <input type="hidden" id="id" name="id">
