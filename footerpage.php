...
?>
    ...
    <body>
        ...
        include_once("include/footerpage_content.php");
        ?>
                ...
                if (id == undefined) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            tinyMCE.get("tone").setContent(data.tone);
                            tinyMCE.get("ttwo").setContent(data.ttwo);
                            tinyMCE.get("tthree").setContent(data.tthree);
                            tinyMCE.get("btn_text").setContent(data.btn_text);
                            $("#id").val(data.id);
                        },
                        error: function(error) {
                            console.log(error);
